...
for (const url of await page.locator('a[href],img[src],video source[src]').evaluateAll(els=>els.map(e=>e.getAttribute('href')||e.getAttribute('src')).filter(x=>x?.startsWith('/')))) {
